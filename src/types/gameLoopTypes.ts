...
export const STAGE_CONFIGS: StageMetadata[] = [
  {
    ...
    number: 1,
    label: 'Prolog Aksara',
    bloomLevel: 'Prolog & Orientasi',
    bloomTaxonomy: 'PROLOGUE',
    subtitle: 'Kebangkitan & Orientasi',
    iconName: 'Sparkles',
    accentColor: '#00F2FE',
  },
  {
    id: 'WORLD_MAP',
    number: 2,
    label: 'Peta Kepulauan',
    bloomLevel: 'Pusat Kepulauan',
    bloomTaxonomy: 'HUB',
    subtitle: 'Navigasi 6 Kepulauan Proseduria',
    iconName: 'Map',
    accentColor: '#D4AF37',
  },
  {
    ...
    bloomLevel: 'Eksplorasi Takaran & Struktur',
    bloomTaxonomy: 'C2',
  ...
  },
  {
    id: 'MISSION_01',
    number: 4,
    label: 'M01 Practice Room',
    bloomLevel: 'Investigasi & Rekonstruksi',
    bloomTaxonomy: 'C2',
    subtitle: 'Practice Room — Akademi PROSEDURIA',
    iconName: 'Coffee',
    accentColor: '#FFE082',
  },
  {
    ...
    number: 5,
    label: 'Urutan Logis',
    bloomLevel: 'Rangkaian Kronologis',
    bloomTaxonomy: 'C3',
  ...
  },
  {
    id: 'PROCEDURE_GLITCH',
    number: 6,
    label: 'Deteksi Kerancuan',
    bloomLevel: 'Investigasi Glitch Teks',
    bloomTaxonomy: 'C4',
  ...
  },
  {
    ...
    number: 7,
    label: 'Papan Bukti',
    bloomLevel: 'Korelasi Kaidah Bahasa',
    bloomTaxonomy: 'C4',
  ...
  },
  {
    ...
    bloomLevel: 'Penyuntingan & Perbaikan',
    bloomTaxonomy: 'C5',
  ...
  },
  {
    ...
    number: 9,
    label: 'Uji Simulasi',
    bloomLevel: 'Simulasi Keberhasilan',
    bloomTaxonomy: 'C5',
  ...
  },
  {
    ...
    bloomLevel: 'Pencapaian Prestasi',
  ...
  },
  {
    ...
    bloomLevel: 'Kemahiran Menjelajah',
    bloomTaxonomy: 'SPECIAL',
  ...
  },
  {
    id: 'PROCEDURE_FORGE',
    number: 12,
    label: 'Tungku Cipta Prosedur',
    bloomLevel: 'Kreasi Pusaka Mandiri',
    bloomTaxonomy: 'C6',
  ...
  },
  {
    ...
    bloomLevel: 'Tantangan Pamungkas',
    bloomTaxonomy: 'SPECIAL',
